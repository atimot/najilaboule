...
const checks = [
  ...
  ['canonical', html.includes('<link rel="canonical" href="https://najilaboule.com/"')],
  ['JSON-LD Restaurant', /<script type="application\/ld\+json">\s*\{"@context":"https:\/\/schema\.org","@type":"Restaurant"/.test(html)],
  ['og:image', html.includes('content="https://najilaboule.com/images/ogp.jpg"')],
  ['skip link', html.includes('class="skip-link"')],
  ['theme-color', html.includes('<meta name="theme-color" content="#241816"')],
  ['SVG favicon の link', html.includes('<link rel="icon" type="image/svg+xml" href="/favicon.svg"')],
  ['旧 GitHub Pages の URL と base パス (/najilaboule/) が残っていない (2026-09-25 に独自ドメインへ移行)', !/atimot\.github\.io/.test(html) && !/(?:href|src|content)="\/najilaboule\//.test(html)],
