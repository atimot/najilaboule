...
const checks = [
  ...
  ['壱 (concept) は写真 2 枚以上でスライドショーが付く (chapter__frame--slideshow)', /class="chapter__frame chapter__frame--slideshow"/.test(section('concept')) && (section('concept').match(/class="chapter__slide"/g) ?? []).length >= 2],
