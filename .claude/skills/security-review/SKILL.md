...
このスキルは、すべてのコードがセキュリティベストプラクティスに従っていることを確認し、潜在的な脆弱性を特定する。
...
**注意**: セキュリティは任意ではない。1つの脆弱性がプラットフォーム全体を危険にさらす可能性がある。迷った場合は慎重な側に倒すこと。
